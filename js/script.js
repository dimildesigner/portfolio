...
const dadosProjetos = {
    1: { img: "img/folio/gallery/dimildesigner_port_img01g.png", titulo: "Projeto 1", desc: "Descrição detalhada do Projeto 1" },
    2: { img: "img/folio/dimildesigner_port_img02.jpg", titulo: "Projeto 2", desc: "Descrição detalhada do Projeto 2" },
    3: { img: "img/folio/gallery/dimildesigner_port_img03g.jpg", titulo: "Projeto 3", desc: "Descrição detalhada do Projeto 3" },
    4: { img: "img/folio/gallery/dimildesigner_port_img04g.jpg", titulo: "Projeto 4", desc: "Descrição detalhada do Projeto 4" },
    5: { img: "img/folio/gallery/dimildesigner_port_img05g.jpg", titulo: "Projeto 5", desc: "Descrição detalhada do Projeto 5" },
    6: { img: "img/folio/gallery/dimildesigner_port_img06g.jpg", titulo: "Projeto 6", desc: "Descrição detalhada do Projeto 6" },
};
...
const velocidadeDigitacao = 130; // ms por caractere
