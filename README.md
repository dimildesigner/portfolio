...
- Apresentar meus projetos práticos em desenvolvimento Front-end  
- Demonstrar minhas habilidades com tecnologias modernas  
- Evidenciar minha transição de carreira para Tecnologia da Informação  
- Consolidar minha presença profissional como desenvolvedor  
...
Sou um Desenvolvedor Front-end em transição de carreira, com formação em Publicidade e Propaganda e sólida experiência como Designer Gráfico e Motion Designer.
...
Minha atuação está focada na interseção entre:
...
Este portfólio reúne projetos práticos com foco em:
...
Entre os projetos (em evolução), estão:
